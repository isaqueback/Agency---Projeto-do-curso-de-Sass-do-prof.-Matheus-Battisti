<template>
  <v-container id="main-banner">
    <v-row class="nav-container">
      <v-col cols="5">
        <a href="#" class="brand"> <i class="fas fa-brain"></i> Agency </a>
      </v-col>
      <v-col cols="7 nav">
        <nav>
...
#main-banner
  background: linear-gradient(rgba(0, 0, 0, .6), rgba(0, 0, 0, .6)), url('../assets/img/office.jpg')
  height: 85vh
